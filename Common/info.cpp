...
std::vector<Consumer> info::m_syntax = {
    ...
    Consumer(Token(Token::Type::KEYWORD, "call"), Consumer::Store(Token(Token::Type::KEYWORD, "memory"), Token(Token::Type::LITERAL_NUMBER_INT, "index")), {Token(Token::Type::LABEL, "label_name")}),
