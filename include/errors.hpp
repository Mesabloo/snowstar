...
public:
    ...
    virtual std::unique_ptr<Error> from(antlr4::ParserRuleContext*, antlr4::ParserRuleContext*, std::string const...) = 0;
    virtual std::unique_ptr<Error> from(antlr4::ParserRuleContext*, antlr4::Token*, std::string const...) = 0;
...
public:
    ...
    virtual std::unique_ptr<Warning> from(antlr4::ParserRuleContext*, antlr4::ParserRuleContext*, std::string const...) = 0;
    virtual std::unique_ptr<Warning> from(antlr4::ParserRuleContext*, antlr4::Token*, std::string const...) = 0;
...
struct ImplicitCastWarning : Warning {
    ...
    virtual std::unique_ptr<Warning> from(antlr4::ParserRuleContext*, antlr4::ParserRuleContext*, std::string const...);
    virtual std::unique_ptr<Warning> from(antlr4::ParserRuleContext*, antlr4::Token*, std::string const...);
};
